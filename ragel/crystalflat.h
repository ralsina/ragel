...
#ifndef _CRYSTAL_FLATCODEGEN_H
#define _CRYSTAL_FLATCODEGEN_H
 ...
 * FlatCodeGen
 */
class CrystalFlatCodeGen : public CrystalCodeGen
{
public:
	CrystalFlatCodeGen( ostream &out ) :
		CrystalCodeGen(out) {};
	virtual ~CrystalFlatCodeGen() {}
